    ...
    void OnRsaUI()
    {
        ...
        if (GUILayout.Button("Save"))
        {
            ...
            else
            {
                ...
                FileUtility.WriteFile(_cryptoData.folderPath, _cryptoData.fileName, ".txt", data, _cryptoData.aesBase64Key, _cryptoData.aesBase64IV);
            }
        }
        ...
        if (GUILayout.Button("Load"))
        {
            ...
            {
                string data = FileUtility.ReadFile(_cryptoData.folderPath, _cryptoData.fileName, ".txt", _cryptoData.aesBase64Key, _cryptoData.aesBase64IV);
