...
namespace Neofect.Utility
{
    public class FileUtility
    {
        ...
        {
            key = string.Format("{0}_{1}", UnityEngine.Application.productName, key);
        ...
        {
            System.IO.File.WriteAllText(Path.Combine(folderPath, string.Format(fileName, extention)), data, Encoding.UTF8);
        }
        ...
        {
            return System.IO.File.ReadAllText(Path.Combine(folderPath, string.Format(fileName, extention)), Encoding.UTF8);
        }
    }
}
